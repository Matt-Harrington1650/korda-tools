...
os.environ["SOPHON_APP_DATA_DIR"] = r"C:\code\ai-tool-hub\internal\testing\tmp_runtime_state_smoke_file"
...
state = rt.handle("add_source", {
  "name": "SMOKE_FILE_MODE_AUTODETECT",
  "sourceType": "folder",
  "path": fixture_file,
...
print(json.dumps({
  ...
  "resolvedSourceMode": (job.get("enumerateDiagnostics") or {}).get("resolvedSourceMode")
}, indent=2))
